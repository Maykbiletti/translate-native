...
4b. Never summarize a long original to fit one call. Only the trusted rewrite worker may segment plain text; the source-blind and preservation reviewers must each receive the complete assembled result through their proper isolated phases. Long structured input remains blocked without a structure-aware segmenter.
