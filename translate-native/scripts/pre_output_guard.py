#!/usr/bin/env python3
"""Installed-skill hook for exact translation and rewrite delivery."""
...
CLIENT_PATH = Path(__file__).with_name("guard_service_client.py")
...
CLIENT_SPEC = importlib.util.spec_from_file_location(
    "blun_installed_hook_service_client", CLIENT_PATH)
